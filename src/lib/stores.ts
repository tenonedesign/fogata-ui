...
function examplePools(): Pool[] {
  return [
    new Pool("16KZRu7TbjZZ8movNZnHcR2SmgqKDqJsoP", "Example Pool 1", "exampleId1", logo, .0000),
    new Pool("16KZRu7TbjZZ8movNZnHcR2SmgqKDqJsoP", "Example Pool 2", "exampleId2", logo, .0000),
