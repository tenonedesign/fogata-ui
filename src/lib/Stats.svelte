    ...
    {#if showStats}
      <div class="flex flex-col items-center mt-4">
        ...
        <div class="text-sm mt-2">
          ...
          <h2><span class="font-semibold">KOIN withdrawn:</span> <span class="tooltip" data-tip="{tFormat(BigInt($pool.state.koin_withdrawn))} VHP">{format(BigInt($pool.state.koin_withdrawn))}</span></h2>
