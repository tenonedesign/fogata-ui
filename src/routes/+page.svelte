<script lang="ts">
  ...
  let showPendingPools: boolean = false;
...
<div class="px-4">
  ...
  <section class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 max-w-[1300px] mx-auto pt-20 pb-60">
    ...
    <Card>
          ...
          <div class="dropdown">
            ...
            <div tabindex="0" class="dropdown-content menu mt-2 p-6 shadow-xl bg-base-100 rounded-box w-screen max-w-[80vw] md:max-w-md">
              ...
              <div class="mt-4">
                ...
                <div class="flex mt-2"><div class="text-2xl">⭐️</div><div class="ml-3">Some pools contribute more to community development.  These are near the top of the list.</div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <button class="btn btn-sm btn-ghost btn-secondary opacity-50 mt-8" on:click={() => {showPendingPools = !showPendingPools}}>
        {#if !showPendingPools}
